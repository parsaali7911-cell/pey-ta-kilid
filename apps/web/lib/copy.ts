...
const COPY: Record<UiLocale, Copy> = {
  fa: {
    ...
    needSubtitle:
      'لازم نیست دقیق بدانی چه محصولی می‌خواهی. متن نیازت را بنویس؛ سیستم آن را ساختاربندی می‌کند و فقط Listingهای واقعی را نشان می‌دهد.',
    needPlaceholder:
    ...
    journey: [
      ...
      { title: 'کشف', body: 'Intent → Search روی Listingهای واقعی' },
      { title: 'مقایسه و قیمت', body: 'مقایسه، RFQ، Quote و سفارش' },
    ],
    catalogTitle: 'کاتالوگ عمومی',
    catalogSubtitle: 'فقط Listingهای منتشرشده. قیمت و موجودی خصوصی فروشنده نمایش داده نمی‌شود.',
    ...
    designHint: 'درخواست طراحی شناسایی شد. Design AI بعداً به Listing واقعی وصل می‌شود؛ فعلاً نتایج مرتبط نشان داده می‌شود.',
    rfqHint: 'برای این نیاز پیش‌نویس RFQ مناسب‌تر است. می‌توانی از Listingها ادامه دهی.',
  ...
  en: {
    ...
    journey: [
      ...
      { title: 'Discovery', body: 'Intent → Search over real listings' },
  ...
  ar: {
    ...
    journey: [
      ...
      { title: 'الاكتشاف', body: 'Intent ثم Search على قوائم حقيقية' },
